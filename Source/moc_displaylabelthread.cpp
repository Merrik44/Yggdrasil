...
**
** Created: Tue Nov 6 20:01:03 2012
...
void DisplayLabelThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        DisplayLabelThread *_t = static_cast<DisplayLabelThread *>(_o);
        switch (_id) {
        case 0: _t->slotSetLabel((*reinterpret_cast< Vector2D(*)>(_a[1])),(*reinterpret_cast< QImage(*)>(_a[2])),(*reinterpret_cast< QLabel*(*)>(_a[3]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData DisplayLabelThread::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject DisplayLabelThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_DisplayLabelThread,
      qt_meta_data_DisplayLabelThread, &staticMetaObjectExtraData }
};
