...
**
** Created: Mon Nov 5 21:27:17 2012
...
void SingleColourChooser::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        SingleColourChooser *_t = static_cast<SingleColourChooser *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData SingleColourChooser::staticMetaObjectExtraData = {
...
const QMetaObject SingleColourChooser::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_SingleColourChooser,
      qt_meta_data_SingleColourChooser, &staticMetaObjectExtraData }
};
